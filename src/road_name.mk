...
LIBS = -L/mingw32/lib -lzip -liconv -L../lib -lcurl -liniparser -lsqliteX -ltinyxml2 -ldblib -loci12 -lorasql12
...
LIB_SRCS = log.c log2.c scheme.c ora_road_name.c sqlite_util.c sqlite_rdcode.c sqlite_bldg.c sqlite_addr.c http_downloader.c util.c road_name.c simplezip.c 
